...
const AudioDetectionActivity = ({ historialMode }) => {
  ...
  const handleConfirmar = async () => {
    ...
    try {
      ...
      console.log('Respuesta correcta:', ejercicio.correctAnswer);
      ...
      <Container maxWidth="sm" sx={{ py: 6 }}>
        <Box sx={{ display: "flex", alignItems: "center", mb: 4 }}>
          ...
          <Typography variant="h5" fontWeight={700} sx={{ ml: 2 }}>
            {ejercicio?.gameName || 'Detección Auditiva'}
          </Typography>
        </Box>

        <Paper elevation={3} sx={{ p: 4, borderRadius: 3 }}>
          <Typography variant="h6" gutterBottom textAlign="center">
            {ejercicio?.question || '¿Escuchaste un sonido?'}
          </Typography>
          ...
          <Grid container spacing={4} sx={{ mt: 4, mb: 2, justifyContent: 'center' }}>
            <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center' }}>
              <Button
                onClick={() => handleSeleccion('Silencio')}
                sx={{
                  width: 120,
                  height: 120,
                  borderRadius: '50%',
                  backgroundColor: seleccion === 'Silencio' ? '#f44336' : '#ffcdd2',
                  color: seleccion === 'Silencio' ? 'white' : '#f44336',
                  display: 'flex',
                  flexDirection: 'column',
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: seleccion === 'Silencio' ? 6 : 1,
                  transition: 'all 0.2s',
                  '&:hover': {
              ...
              >
                ...
                <Typography variant="subtitle1" sx={{ mt: 1, fontWeight: 600 }}>Silencio</Typography>
              </Button>
            </Grid>
            <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center' }}>
              <Button
                onClick={() => handleSeleccion('Sonido')}
                sx={{
                  width: 120,
                  height: 120,
                  borderRadius: '50%',
                  backgroundColor: seleccion === 'Sonido' ? '#4caf50' : '#c8e6c9',
                  color: seleccion === 'Sonido' ? 'white' : '#388e3c',
                  display: 'flex',
                  flexDirection: 'column',
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: seleccion === 'Sonido' ? 6 : 1,
                  transition: 'all 0.2s',
                  '&:hover': {
              ...
              >
                ...
                <Typography variant="subtitle1" sx={{ mt: 1, fontWeight: 600 }}>Sonido</Typography>
              </Button>
            </Grid>
          </Grid>
...
export default AudioDetectionActivity; 