...
const IdentificarNoPerteneceActivity = ({ historialMode }) => {
  ...
  const handleConfirmar = async () => {
    ...
    try {
      ...
      await authService.registrarIntento(id, {
        respuesta: seleccion,
        correcto: esCorrecto
      });
      ...
      <Container maxWidth="sm" sx={{ py: 2 }}>
        <Box sx={{ display: "flex", alignItems: "center", mb: 4 }}>
          ...
          <Typography variant="h5" fontWeight={700} sx={{ ml: 2 }}>
            Identificar cuál no pertenece
          </Typography>
        </Box>
        <Paper elevation={3} sx={{ p: 2, borderRadius: 3 }}>
          <Typography variant="h6" gutterBottom textAlign="center">
            {ejercicio?.question || 'Escucha el audio y elige la opción que no pertenece al grupo'}
          </Typography>
...
export default IdentificarNoPerteneceActivity; 